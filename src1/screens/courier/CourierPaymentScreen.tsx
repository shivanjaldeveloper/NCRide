...
const METHODS: PayMethod[] = [
  ...
  { id: 'cash', name: 'Cash', sub: 'Pay before pickup', icon: 'cash' },
];
    ...
    <ScreenShell>
      ...
      >
          ...
          {METHODS.map((p, i) => {
            ...
            return (
              <TouchableOpacity
                ...
                style={[
                  styles.methodRow,
                  i < METHODS.length - 1 && styles.methodRowBorder,
                ]}
                activeOpacity={0.75}
        ...
        <View style={styles.secureBox}>
          ...
          <Text style={styles.secureText}>
            Payments are PCI-DSS L1 secure · 256-bit encrypted
          </Text>
        </View>
      </ScrollView>
      ...
      <View style={styles.bottomBar}>
        <NCButton
          label="Pay ₹ 99.00"
          iconRight="check"
          onPress={() => navigation.navigate('CourierConfirmed')}
          variant="primary"
          size="lg"
        />
      </View>
...
const styles = StyleSheet.create({
  ...
  defaultBadge: {
    paddingHorizontal: fscale(7),
    paddingVertical: fscale(3),
