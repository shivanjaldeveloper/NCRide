      ...
      >
        <View style={styles.sosCard}>
          ...
          <TouchableOpacity style={styles.holdBtn} activeOpacity={0.85}>
            <Text style={styles.holdBtnText}>HOLD 3 SECONDS TO ALERT</Text>
          </TouchableOpacity>
        </View>
        ...
        <NCCard style={styles.card}>
          ...
          {EMERGENCY_CONTACTS.map(c => (
            <Row
              ...
              title={c.title}
              sub={c.sub}
              right={<Icon name="phone" size={18} stroke={Colors.green} />}
            />
          ))}
          <NCButton
            label="Add contact"
        ...
        <NCCard style={styles.card}>
          ...
          <Row
            ...
            sub="Avg reply 28 sec · 24×7"
            onPress={() => navigation.navigate('Chat')}
          />
          <Row
            icon="phone"
            title="Call helpline"
            sub="1800 200 NCR-IDE (62743)"
            onPress={() => {}}
          />
          <Row
            icon="invoice"
            title="Report an issue"
            sub="Driver behaviour, lost item, fare dispute"
            onPress={() => {}}
          />
          <Row
            icon="shield"
