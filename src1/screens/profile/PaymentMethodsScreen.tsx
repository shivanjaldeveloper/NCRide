...
// Matches the dataset used on PayRideScreen/CourierPaymentScreen for consistency.
        ...
        <View style={styles.cardVisual}>
          ...
          <View style={styles.cardTopRow}>
            ...
            <View style={styles.cardLogo}>
              ...
              <View
                style={[
                  styles.cardLogoCircle,
                  { right: 0, backgroundColor: '#F79E1B' },
                ]}
              />
            </View>
          </View>
            ...
            <View key={m.id}>
              <View style={styles.methodRow}>
                <View style={styles.methodIconWrap}>
                  <Icon name={m.icon} size={18} stroke={Colors.ink} />
                </View>
                <View style={{ flex: 1 }}>
