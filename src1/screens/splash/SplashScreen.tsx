...
const SplashScreen = ({ navigation }: Props) => {
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(async () => {
      ...
      // First-time user: show Onboarding → LanguageSelect
      // Returning user who already set language: show Onboarding directly
      // (Onboarding itself navigates to LanguageSelect on "Get started")
