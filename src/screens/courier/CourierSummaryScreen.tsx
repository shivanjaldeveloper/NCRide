    ...
    >
      ...
      <NCCard>
        <View style={styles.serviceRow}>
          <View style={styles.serviceIcon}>
            <Icon name="courier" size={22} stroke={Colors.ink} />
          </View>
          <View style={{ flex: 1 }}>
        ...
        <View style={styles.detailsGrid}>
          {[
            ...
            ['Weight', '< 0.5 kg · Documents'],
            ['ETA', 'Pickup in 18 min'],
          ].map(([k, v]) => (
      ...
      <NCCard style={styles.card}>
        ...
        <View style={styles.fareRow}>
          <Text style={[styles.fareKey, { color: Colors.green }]}>
            Coupon · PARCEL25
          </Text>
      ...
      >
        <NCCard pad={0}>
          <Row
            icon="coupon"
            title="Apply coupon"
            sub="8 offers available · PARCEL25 saves ₹25"
          />
        </NCCard>
      </TouchableOpacity>
      ...
      <View style={styles.infoBox}>
        ...
        <Text style={styles.infoText}>
          Pay before pickup · Delivery within 2–4 hours
        </Text>
      </View>
    </ScrollView>
