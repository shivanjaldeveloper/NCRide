...
const RECEIPT_LINES: [string, string][] = [
  ['Trip', 'Sector 62, Noida → Connaught Place'],
  ['Date', '18 Mar 2026 · 4:42 PM'],
  ['Driver', 'Rajat Kr. Saha'],
  ['Vehicle', 'Auto Rickshaw · DL 5C NC 4421'],
  ['Distance', '9.4 km · 24 min'],
  ['Method', 'UPI · arya@ncrride'],
];

/** Deterministic QR-style decorative pattern, ported from the reference's
 * inline-generated dot grid (8x8 grid, skip every 3rd cell). */
const QRPattern = () => {
  const cells = useMemo(() => {
  ...
  return (
    <Svg width={48} height={48} viewBox="0 0 60 60">
      {cells.map((c, i) => (
        <Rect key={i} x={c.x} y={c.y} width={6} height={6} fill={Colors.ink} />
      ))}
    </Svg>
  );
};
      ...
      >
        <View style={styles.successWrap}>
          ...
          <Text style={styles.successSub}>
            ₹ 184.00 charged to UPI · arya@ncrride
          </Text>
        </View>
        ...
        <View style={styles.rewardCard}>
          ...
          <View style={{ flex: 1 }}>
            ...
            <Text style={styles.rewardValue}>+184 NCRide points</Text>
          </View>
...
const styles = StyleSheet.create({
  content: {
    ...
    paddingTop: fscale(28),
    paddingBottom: fscale(100),
  },
