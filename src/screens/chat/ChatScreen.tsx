        ...
        >
          {messages.map((m, i) => (
            <View
              ...
              style={[
                styles.bubbleRow,
                m.me ? styles.bubbleRowMe : styles.bubbleRowThem,
              ]}
            >
              <View
                style={[
                  ...
                  m.me ? styles.bubbleMeRadius : styles.bubbleThemRadius,
                ]}
              >
                <Text style={[styles.bubbleText, m.me && styles.bubbleTextMe]}>
                  {m.text}
                </Text>
                <Text
                  style={[
                    styles.bubbleTime,
                    m.me ? styles.bubbleTimeMe : styles.bubbleTimeThem,
                  ]}
                >
                  {m.time}
                </Text>
