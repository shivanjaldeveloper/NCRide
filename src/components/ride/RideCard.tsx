...
export type RideGlyph = 'sedan' | 'suv' | 'auto' | 'bike';
    ...
    case 'sedan':
      return (
        <Svg width={56} height={35} viewBox="0 0 64 40">
          ...
          <Rect x={14} y={16} width={36} height={12} rx={3} fill="#9AC8FF" opacity={0.85} />
          <Circle cx={18} cy={32} r={5} fill="#0F1115" stroke="#fff" strokeWidth={2} />
          <Circle cx={46} cy={32} r={5} fill="#0F1115" stroke="#fff" strokeWidth={2} />
        </Svg>
      );
    case 'suv':
      return (
        <Svg width={56} height={35} viewBox="0 0 64 40">
          ...
          <Rect x={12} y={12} width={40} height={14} rx={3} fill="#9AC8FF" opacity={0.85} />
          <Circle cx={16} cy={34} r={5} fill="#0F1115" stroke="#fff" strokeWidth={2} />
          <Circle cx={48} cy={34} r={5} fill="#0F1115" stroke="#fff" strokeWidth={2} />
        </Svg>
      );
    case 'auto':
      return (
        <Svg width={56} height={35} viewBox="0 0 64 40">
          ...
          <Rect x={22} y={14} width={20} height={10} rx={2} fill="#0F1115" opacity={0.85} />
          <Circle cx={22} cy={32} r={5} fill="#0F1115" stroke="#fff" strokeWidth={2} />
          <Circle cx={50} cy={32} r={5} fill="#0F1115" stroke="#fff" strokeWidth={2} />
        </Svg>
      );
    case 'bike':
      return (
        <Svg width={56} height={35} viewBox="0 0 64 40">
          <Ellipse cx={32} cy={36} rx={22} ry={2} fill="rgba(0,0,0,0.1)" />
          <Circle cx={14} cy={30} r={6} fill="none" stroke="#0F1115" strokeWidth={3} />
          <Circle cx={50} cy={30} r={6} fill="none" stroke="#0F1115" strokeWidth={3} />
          <Path
            ...
            strokeLinecap="round"
          />
          <Path d="M44 18 L40 10" stroke="#0F1115" strokeWidth={3} strokeLinecap="round" />
 ...
 */
const RideCard = ({ ride, selected, onSelect }: Props) => {
  return (
    <TouchableOpacity
      activeOpacity={0.85}
    ...
    >
      ...
      <View style={styles.info}>
        <View style={styles.nameRow}>
          <Text style={[styles.name, selected && styles.textInverse]}>{ride.name}</Text>
          <Text style={[styles.seats, selected && styles.textInverseFaint]}>
            · {ride.max} seats
          </Text>
        </View>
        <View style={styles.metaRow}>
          <Text style={[styles.eta, { color: selected ? Colors.lime : Colors.green }]}>
            {ride.eta} away
          </Text>
          <Text style={[styles.tag, selected && styles.textInverseFaint]}>· {ride.tag}</Text>
        </View>
      </View>
      <View style={styles.fareWrap}>
        <Text style={[styles.fare, selected && styles.textInverse]}>₹{ride.fare}</Text>
        <Text style={[styles.fareStrike, selected && styles.textInverseFaint]}>
          ₹{ride.fare + 32}
        </Text>
      </View>
    </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  metaRow: { flexDirection: 'row', alignItems: 'center', gap: fscale(6), marginTop: 2 },
